...
/**
 * Criteria class for the {@link ma.gov.marrakech.domain.Sdl} entity. This class is used
 * in {@link ma.gov.marrakech.web.rest.SdlResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /Sdls?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class SdlCriteria implements Serializable, Criteria {
    ...
    public SdlCriteria(SdlCriteria other) {
    ...
    @Override
    public SdlCriteria copy() {
        return new SdlCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final SdlCriteria that = (SdlCriteria) o;
        return
